...
class UpdateMay2026CustomIds extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'work:update-may-ids';
     ...
     * @var string
     */
    protected $description = 'Update custom_ids for Work models created in May 2026 to be continuous from April';
    ...
    {
        $this->info('Finding works created in May 2026...');

        // Get works created in May 2026, ordered by ID so they are updated sequentially
        ...
        if ($works->isEmpty()) {
            $this->info('No works found for May 2026.');
            return;
        }
        ...
        DB::transaction(function () use ($works, $prefix, &$counters) {
            foreach ($works as $work) {
                ...
                // Initialize the counter for this valuer based on their last work before May
        ...
        $this->info('Successfully updated custom_ids for May 2026!');
    }
}

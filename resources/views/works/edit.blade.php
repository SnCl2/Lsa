    ...
    <form action="{{ route('works.update', $work->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-group col-md-4">
                ...
                <input type="number" step="0.01" class="form-control" id="actual_value" name="actual_value" value="{{ $work->actual_value }}" placeholder="Enter FMV">
            </div>
            <div class="form-group col-md-4">
                <label for="realised_value">RV</label>
                <input type="number" step="0.01" class="form-control" id="realised_value" name="realised_value" value="{{ $work->realised_value }}" placeholder="Enter RV">
            </div>
            <div class="form-group col-md-4">
                <label for="fair_market_value">DV</label>
                <input type="number" step="0.01" class="form-control" id="fair_market_value" name="fair_market_value" value="{{ $work->fair_market_value }}" placeholder="Enter DV">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
        ...
        <div class="form-row">
            ...
            <div class="form-group {{ (auth()->user()->roles->contains('name', 'Super Admin') || auth()->user()->roles->contains('name', 'KKDA Admin')) ? 'col-md-4' : 'col-md-6' }}">
                ...
                <div class="custom-control custom-switch mt-2">
                    ...
                    <input type="checkbox" class="custom-control-input" id="is_hold" name="is_hold" value="1" {{ old('is_hold', $work->is_hold) ? 'checked' : '' }}>

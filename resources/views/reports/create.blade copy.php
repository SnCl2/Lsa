...
<div class="container-fluid mt-4">
    <div class="row">
            ...
            <div class="card shadow-sm p-3 h-100 overflow-auto">
                ...
                <form id="inputForm">
                    <div class="form-group">
                        ...
                        <input type="text" id="racpc"  name="racpc" class="form-control" placeholder="Type something..." value="{{old('racpc_in')}}">
                    </div>
                    <div class="form-group">
                        ...
                        <textarea id="report_description" name="report_description" class="form-control" rows="10">
                            SELF CONTAINED FLAT/UNIT/APARTMENT NO. {{ $work->inspection->flat_no ?? '------' }}, ON THE {{ $work->inspection->floor ?? '-------' }} FLOOR, TYPE {{ $work->inspection->property_type ?? '--------------' }}, BLOCK {{ $work->inspection->block ?? '------------' }}, LOCATED AT {{ $work->inspection->located_at_side ?? '---------------' }}, OF THE R.C.C. FRAME WITH ROOFED OF {{ $work->inspection->number_of_floors ?? '---------------' }} -STORIED RESIDENTIAL BUILDING & STRUCTURE, KNOWN AS “{{ $work->inspection->apartment_name ?? '-------------------------' }}”, MEASURING SUPER BUILT-UP AREA/BUILT-UP AREA/CARPET AREA : {{ $work->inspection->super_built_up_area ?? '------------' }} SQ.FT./SQ.MTR. (MORE-OR-LESS), SITUATED AT: HOLDING NO. /PREMISES NO. {{ $work->inspection->holding_no ?? '---------' }}, MAKHLA 2 NO. GOVT. COLONY, P.O.: {{ $work->inspection->post_office ?? '----------------' }}, P.S.: {{ $work->inspection->police_station ?? '--------------' }}, PIN/KOLKATA – {{ $work->inspection->pin_code ?? '--------------' }}, MOUZA – {{ $work->inspection->ward ?? '---------' }}, J.L. NO.: ------, C.S. DAG NO. ------------------, R.S. DAG NO. --------------- L.R. DAG NO. -----------, L.R. KHATIAN NO. --------------, DISTRICT– {{ $work->inspection->district ?? '-------------------' }}, WITHIN WARD NO.: --------------, UNDER ----------------------- PANCHAYET/MUNICIPALITY/MUNICIPAL CORPORATION.

                    </textarea>
                    </div>
                    <div class="form-group">
                        <label for="OWNER">OWNER Description</label>
                        <textarea id="OWNER" name="OWNER" class="form-control" rows="10">@foreach($work->relatives as $relative)
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="PURCHASER_BORROWER" name="PURCHASER_BORROWER" class="form-control" rows="10">-----------, RESIDING AT- HOLDING NO. /PREMISES NO.---------, MAKHLA 2 NO. GOVT. COLONY, P.O.: ----------------,
                            P.S.: --------------, PIN/KOLKATA –--------------.</textarea>
                    </div>
                    <div class="form-group">
                        <label for="purpose">PURPOSE FOR WHICH THE VALUATION IS MADE</label>
                        <textarea id="purpose" name="purpose" class="form-control" rows="5">TO ASSESS FAIR MARKET VALUE OF THE SAID
                    PROPERTY.
                    NPA/PERSONAL/REVALUATION/RESALE/TOP-UP/
                    SECURITY AND BANK FINANCE FOR F.M.V PURPOSE</textarea>
                    </div>
                    <div class="form-group">
       ...
       value="{{ optional($work->inspection)->updated_at ? \Carbon\Carbon::parse($work->inspection->updated_at)->format('Y-m-d') : '' }}">
                    ...
                    <div class="form-group">
                        ...
                        <label for="cs_dag_no">C.S. DAG NO. OR PLOT NO.</label>
                        <input type="text" id="cs_dag_no" name="cs_dag_no" class="form-control">

                        <label for="rs_dag_no">R.S. DAG NO. OR PLOT NO.</label>
                        <input type="text" id="rs_dag_no" name="rs_dag_no" class="form-control">

                        <label for="lr_dag_no">L.R. DAG NO. OR PLOT NO.</label>
                        <input type="text" id="lr_dag_no" name="lr_dag_no" class="form-control">
                        ...
                        <select type="text" id="village_mouza" name="village_mouza" class="form-control">
                        ...
                        <input type="date" id="layout_validity" name="layout_validity" class="form-control">
                        ...
                        <input type="text" id="Feasibility" name="Feasibility" class="form-control">
                        ...
                        <select name="lift" id="lift" class="form-control">
                            ...
                            <select name="door_type" id="door_type" class="form-control">
                                ...
                                <option value="pvc_door">PVC (UPVC) Door</option>
                                <option value="french_door">French Door</option>
                                <option value="sliding_door">Sliding Door</option>
                                <option value="folding_door">Folding Door (Bi-Fold Door)</option>
                            ...
                            <textarea name="composite_rate" id="composite_rate" class="form-control"></textarea>
...
$(document).ready(function(){
    ...
    updateOutput("#PURCHASER_BORROWER", "#OWNER_out2");
    updateOutput("#OWNER", "#PURCHASER_BORROWERS_out3");

        ...
        <div class="col-md-4">
            <div class="card shadow-sm p-3  overflow-auto" style="position: fixed; top: 90px; left: 20px; width: 450px; height: 750px; resize: both; overflow: auto;" id="fixedCard">
                ...
                <form id="inputForm">
                    ...
                    <input type="text" id="type1"  class="form-control" value="OWNER Description">
                    ...
                    <div class="form-check my-2">
                        <input type="checkbox" id="Show1" name="Show1" class="form-check-input" value="Show1" onchange="toggleSection(1)">
                        <label for="Show1" class="form-check-label">Show Description</label>
                    </div>
                
                    <!-- PURCHASER/BORROWER Description Section -->

                    <input type="text" id="type2"  class="form-control" value="PURCHASER/BORROWER Description">
                ...
                P.S.: --------------, PIN/KOLKATA –--------------.
                    ...
                    <div class="form-check my-2">
                        <input type="checkbox" id="Show2" name="Show2" class="form-check-input" value="Show2" onchange="toggleSection(2)" >
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="postal_address" name="postal_address" class="form-control" rows="3"></textarea>
                        ...
                        <select name="lift" id="lift" class="form-control">
                            ...
                            <div style="display: flex; gap: 8px;">
                              ...
                              <select id="undivided_area_unit" class="form-select" style="max-width: 120px;">
                                    ...
                                    <table class="table table-bordered mt-4">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input id="IDENTITY" type="text" class="form-control"   ></td>
                                            </tr>
                                            <tr>
                ...
                <form id="reportForm" action="{{ route('report.update', $report->id) }}" method="POST">
                    ...
                    <input type="text" id="work_id" name="work_id" value="{{ $report->work_id }}">
                    <br>
...
<script>
    document.querySelectorAll('.extent-checkbox2').forEach(checkbox => {
        checkbox.addEventListener('change', function() {
            ...
            // Update the input field with selected values (comma-separated)
            document.getElementById('EXTENT_SITE_2').value = selectedValues.join(', ');
            document.getElementById('qty_1').value = selectedValues.join(', ');
        });
    });
</script>
<script>
...
<script>
document.addEventListener('DOMContentLoaded', function () {
    var checkbox = document.getElementById('Show2');
...
<script>
document.addEventListener('DOMContentLoaded', function () {
    var checkbox = document.getElementById('Show1');
    if (checkbox.value === 'on') {
        checkbox.checked = true;
    }
});

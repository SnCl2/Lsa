...
<div class="container-fluid mt-4">
    <div class="row">
        <!-- Input Section -->
        <div class="col-md-4">
            <div class="card shadow-sm p-3  overflow-auto" style="position: fixed; top: 90px; left: 20px; width: 450px; height: 750px; resize: both; overflow: auto;" id="fixedCard">
                <h4>Inputs</h4>
                <form id="inputForm">
                    @csrf
                    <input type="hidden" id="work_id" value="{{ $work->id }}">
                    <div class="form-group">
                    <label for="racpc">ID</label>
                    <input type="text" class="form-control" id="work_id_2" value="{{ $work->id }}">
                    </div>
                    <div class="form-group">
                    <label for="inspection_date">Date of Report</label>
                        <input type="date" 
                       id="Report_date" 
                       name="Report_date" 
                       class="form-control" 
                    ...
                    <div class="form-group">
                        ...
                        <select id="property_type" name="property_type" onchange="updatePropertyType()" class="form-control">
                        ...
                        <textarea id="report_description" name="report_description" class="form-control" rows="10">
                            SELF CONTAINED FLAT NO. {{ $work->inspection->flat_no ?? '------' }}, ON THE {{ $work->inspection->floor ?? '-------' }} FLOOR, TYPE {{ $work->inspection->property_type ?? '--------------' }}{{ !empty($block_data->block) ? ', BLOCK: ' . $block_data->block : '' }}, LOCATED AT {{ $work->inspection->located_at_side ?? '---------------' }}, OF THE R.C.C. FRAME WITH ROOFED OF {{ $work->inspection->number_of_floors ?? '---------------' }} -STORIED RESIDENTIAL BUILDING & STRUCTURE, KNOWN AS {{ $work->inspection->apartment_name ?? '-------------------------' }}, MEASURING {{ $line }} (MORE-OR-LESS), SITUATED AT: PREMISES NO. {{ $work->inspection->holding_no ?? '---------' }}, P.O.: {{ $work->inspection->post_office ?? '----------------' }}, P.S.: {{ $work->inspection->police_station ?? '--------------' }}, KOLKATA – {{ $work->inspection->pin_code ?? '--------------' }}, [MOUZA], [DAG],  DISTRICT– {{ $work->inspection->district ?? '-------------------' }}, WITHIN WARD NO.: {{ $work->inspection->ward ?? '------' }}, UNDER {{ $work->inspection->authority ?? '-----------------' }}.
                        </textarea>
                    <label for="list_of_doc">LIST OF DOCUMENTS PRODUCED FOR PERUSAL</label>
                        <input type="text" id="list_of_doc" name="list_of_doc" class="form-control" value="">
                    </div>
                    <div class="form-group">
                ...
                @endforeach
                    ...
                    <textarea id="PURCHASER_BORROWER" name="PURCHASER_BORROWER" class="form-control" rows="10">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" id="shoe_type1"  class="form-control" >
                

                    <textarea id="shoe_OWNER" name="OWNER" class="form-control" rows="10" style="display:none;">
                    ...
                    <input type="hidden" id="show_type2"  class="form-control" >
                

                    <textarea id="shoe_PURCHASER_BORROWER" name="PURCHASER_BORROWER" class="form-control" rows="10" style="display:none;">
                    ...
                    <div class="form-group">
                        ...
                        <select id="valuation_PURPOSE" name="valuation_PURPOSE" onchange="updatePurpose()" class="form-control">
                        ...
                        TO ASSESS FAIR MARKET VALUE OF THE SAID PROPERTY FOR THE PURPOSE OF NPA
                        </textarea>
                    </div>
                    <div class="form-group">
                        <label for="inspection_date">Date of Inspection</label>
                        <input type="date" id="inspection_date" name="inspection_date" class="form-control" value="{{ optional($work->inspection)->created_at ? \Carbon\Carbon::parse($work->inspection->created_at)->format('Y-m-d') : '' }}">


                    </div>
                    <div class="form-group">
                        <label for="valuation_date">Date of Valuation</label>
                        <input type="date" id="valuation_date" name="valuation_date" class="form-control" value="{{ date('Y-m-d') }}">
                        ...
                        <input type="text" id="door_no" name="door_no" class="form-control" value="{{ $work->inspection->holding_no ?? '' }}">
                        ...
                        <input type="text" id="ward_taluka" name="ward_taluka" class="form-control" value="{{ $work->inspection->ward ?? '' }}">

                        <label for="mandal_district">Mandal / District</label>
                        <input type="text" id="mandal_district" name="mandal_district" class="form-control" value="{{ $work->inspection->district ?? '' }}">
                        ...
                        <input type="text" id="approved_authority" name="approved_authority" class="form-control" value="{{ $work->inspection->authority ?? '' }}">
                        ...
                        <input type="text" id="corporation_limit" name="corporation_limit" class="form-control" value="{{ $work->inspection->authority ?? '' }}">
                        ...
                        <label for="govt_enactments">Whether Covered Under Any State /<br> Central Govt. Enactments (e.g. Urban Land Ceiling Act) or Notified Under Agency Area /<br><br> Scheduled Area /<br> Cantonment Area</label>
                        ...
                        <table class="table table-bordered mt-4">
                            ...
                            <tr>
                                ...
                                <td><input type="text" id="north_building" name="north_building" class="form-control" value="{{$work->inspection->boundary_building_actual_north ?? ''}}" ></td>
                                <td><input type="text" id="north_flat" name="north_flat" class="form-control" value="{{$work->inspection->boundary_flat_actual_north ?? ''}}"></td>
                            </tr>
                            <tr>
                                <td>SOUTH</td>
                                <td><input type="text" id="south_agreement" name="south_agreement" class="form-control"></td>
                                <td><input type="text" id="south_building" name="south_building" class="form-control" value="{{$work->inspection->boundary_building_actual_south ?? ''}}"></td>
                                <td><input type="text" id="south_flat" name="south_flat" class="form-control" value="{{$work->inspection->boundary_flat_actual_south ?? ''}}"></td>
                            </tr>
                            <tr>
                                <td>EAST</td>
                                <td><input type="text" id="east_agreement" name="east_agreement" class="form-control"></td>
                                <td><input type="text" id="east_building" name="east_building" class="form-control" value="{{$work->inspection->boundary_building_actual_east ?? ''}}"></td>
                                <td><input type="text" id="east_flat" name="east_flat" class="form-control" value="{{$work->inspection->boundary_flat_actual_east ?? ''}}"></td>
                            </tr>
                            <tr>
                                <td>WEST</td>
                                <td><input type="text" id="west_agreement" name="west_agreement" class="form-control"></td>
                                <td><input type="text" id="west_building" name="west_building" class="form-control" value="{{$work->inspection->boundary_building_actual_west ?? ''}}"></td>
                                <td><input type="text" id="west_flat" name="west_flat" class="form-control"value="{{$work->inspection->boundary_flat_actual_west ?? ''}}"></td>
                            </tr>
                        </table>
                        <table class="table table-bordered mt-4">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" id="north_PLAN" name="north_PLAN" class="form-control" value="{{$work->inspection->dimensions_flat_deed_north ?? ''}}"></td>
                                <td><input type="text" id="north_ACTUAL" name="north_ACTUAL" class="form-control" value="{{$work->inspection->dimensions_flat_actual_north ?? ''}}"></td>
                            </tr>
                            <tr>
                                <td>SOUTH</td>
                                <td><input type="text" id="south_DIMENSION" name="south_DIMENSION" class="form-control"></td>
                                <td><input type="text" id="south_PLAN" name="south_PLAN" class="form-control" value="{{$work->inspection->dimensions_flat_deed_south ?? ''}}"></td>
                                <td><input type="text" id="south_ACTUAL" name="south_ACTUAL" class="form-control" value="{{$work->inspection->dimensions_flat_actual_south ?? ''}}"></td>
                            </tr>
                            <tr>
                                <td>EAST</td>
                                <td><input type="text" id="east_DIMENSION" name="east_DIMENSION" class="form-control"></td>
                                <td><input type="text" id="east_PLAN" name="east_PLAN" class="form-control" value="{{$work->inspection->dimensions_flat_deed_east ?? ''}}"></td>
                                <td><input type="text" id="east_ACTUAL" name="east_ACTUAL" class="form-control" value="{{$work->inspection->dimensions_flat_actual_east ?? ''}}"></td>
                            </tr>
                            <tr>
                                <td>WEST</td>
                                <td><input type="text" id="west_DIMENSION" name="west_DIMENSION" class="form-control"></td>
                                <td><input type="text" id="west_PLAN" name="west_PLAN" class="form-control" value="{{$work->inspection->dimensions_flat_deed_west ?? ''}}"></td>
                                <td><input type="text" id="west_ACTUAL" name="west_ACTUAL" class="form-control" value="{{$work->inspection->dimensions_flat_actual_west ?? ''}}"></td>
                            </tr>
                        </table>
                        <table class="table table-bordered mt-4">
                            <tr>
                        ...
                        <input type="text" id="Facility" name="Facility" class="form-control" value="{{ $work->address_line_2 ?? '--' }}">
                        ...
                        <input type="text" id="Year_of_Construction" name="Year_of_Construction" class="form-control" value="{{ $work->inspection->year_of_construction ?? '' }}" oninput="calculateBuildingAge()">
                        ...
                        <select name="lift" id="lift" class="form-control">
                            ...
                            <input type="text" name="door_no_2" id="door_no_2" class="form-control" value="{{ $work->inspection->flat_no ?? '--' }}">

                            <label for="roof">ROOF:</label>
                            <select name="roof" id="roof" class="form-control">
                                <option value="rcc_slab">RCC Slab</option>
                                <option value="karibarga">Karibarga</option>
                                <option value="tin_shed">Tin Shed</option>
                                <option value="pvc_shed">PVC Shed</option>
                                <option value="rt_shed">RT Shed</option>
                            </select>
                            ...
                            @php
                                ...
                                $accommodationSummary = "Light Points: " . ($inspection?->light_points ?? 'N/A') .
                                    ", Fan Points: " . ($inspection?->fan_points ?? 'N/A') .
                                    ", Water Closets: " . ($inspection?->water_closets ?? 'N/A') .
                                    ", Washbasins: " . ($inspection?->washbasins ?? 'N/A') .
                                    ", Bathtubs: " . ($inspection?->bathtubs ?? 'N/A') .
                                    ", Plug Points: " . ($inspection?->plug_points ?? 'N/A') .
                                    ", Door Type: " . ($inspection?->door_type ?? 'N/A') .
                                    ", Flooring Type: " . ($inspection?->flooring_type ?? 'N/A') .
                                    ", Window Type: " . ($inspection?->window_type ?? 'N/A') .
                                    ", Wiring Type: " . ($inspection?->wiring_type ?? 'N/A');
                            @endphp


                            <label for="ACCOMMODATION">ACCOMMODATION</label>
                            <input type="text" name="ACCOMMODATION" id="ACCOMMODATION" class="form-control" value={{$accommodationSummary}} >
                            ...
                            <div style="display: flex; gap: 8px;">
                              ...
                              <select id="undivided_area_unit" class="form-select form-control" style="max-width: 120px;">
                                ...
                                <option value=" Chittak">Chittak</option>
                                
                              </select>
                            </div>

                            <label for="plinth_area">What is the plinth area of the flat?</label>
                            <input type="text" name="plinth_area" id="plinth_area" class="form-control" value="{{ $landAreaData['builtup_area'] ?? '' }}" >
                            ...
                            <input type="text" name="carpet_area" id="carpet_area" class="form-control" value="{{ $landAreaData['carpet_area'] ?? '' }}">
                            ...
                            <label for="composite_rate">After analysing the comparable sale instances, what is the composite rate for a similar flat with same specifications in the adjoining locality?</label>
                                ...
                                Link: <input type="url" id="govt_link" name="govt_link" placeholder="https://example.gov.in" class="form-control"><br>
                                Market Rate: Rs. <input type="number" id="govt_rate" name="govt_rate" step="0.01" placeholder="Rate per decimal" class="form-control"><br><br>
                              
                            

                                <label>2. Price collected from 99acres.com Website:</label><br>
                                Link: <input type="url" id="acres99_link" name="acres99_link" placeholder="https://www.99acres.com" class="form-control"><br>
                                Market Rate: Rs. <input type="number" id="acres99_rate" name="acres99_rate" step="0.01" placeholder="Rate per decimal" class="form-control"><br><br>
                              
                            

                                <label>3. Price collected from realestateindia.com Website:</label><br>
                                Link: <input type="url" name="realestateindia_link" id="realestateindia_link" placeholder="https://www.realestateindia.com" class="form-control"><br>
                                Market Rate: Rs. <input type="number" id="realestateindia_rate" name="realestateindia_rate" step="0.01" placeholder="Rate per decimal" class="form-control"><br><br>
                            ...
                            <table class="table table-bordered mt-4">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" name="qty_1" id="qty_1" class="form-control" value=""></td>
                                    ...
                                    <tr>
                                        <td>2</td>
                                        <td>Wardrobes</td>
                                        <td><input type="text" name="qty_2" id="qty_2" class="form-control" value=""></td>
                                    ...
                                    <tr>
                                        <td>3</td>
                                        <td>Showcases</td>
                                        <td><input type="text" name="qty_3" id="qty_3" class="form-control" value=""></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="qty_4" id="qty_4" class="form-control" value=""></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="qty_5" id="qty_5" class="form-control" value=""></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="qty_6" id="qty_6" class="form-control" value=""></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="qty_7" id="qty_7" class="form-control" value=""></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="qty_8" id="qty_8" class="form-control" value=""></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="qty_9" id="qty_9" class="form-control" value=""></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="qty_10" id="qty_10" class="form-control" value=""></td>
                                    ...
                                    <table class="table table-bordered mt-4">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="BACKGROUND" class="form-select form-control">
                                                        <option value="NO">NO</option>
                                                        <option value="YES">YES</option>
                                                        <option value="OTHERS">OTHERS</option>
                                                    </select>
                                            ...
                                            <tr>
                                                ...
                                                <td><input id="IDENTITY" type="text" class="form-control" value="{{$work->surveyor?->name}}" ></td>
                                            </tr>
                                            <tr>
                                               
                                                <td>DISCLOSURE OF VALUER INTEREST OR CONFLICT, IF ANY;</td>
                                                <td>
                                                    <select id="DISCLOSURE" name="valuation_procedure" class="form-control">
                                                        <option value="NO">NO</option>
                                                        <option value="YES">YES</option>
                                                        <option value="OTHERS">OTHERS</option>
                                                    </select>
                                            ...
                                            <tr>
                                                ...
                                                <td><input id="DATE_OF_APPOINTMENT"type="text" class="form-control" value="{{ $work->created_at ? $work->inspection?->created_at->format('Y-m-d') : '--' }}"></td>
                                            </tr>
                                            <tr>
                                            
                                                <td>INSPECTIONS AND/OR INVESTIGATIONS UNDERTAKEN</td>
                                                <td><input id="INSPECTIONS_UNDERTAKEN" type="text" class="form-control" value="{{ $work->inspection?->created_at ? $work->inspection?->created_at->format('Y-m-d') : '--' }}"></td>
                                            </tr>
                                            <tr>
                                             
                                                <td>NATURE AND SOURCES OF THE INFORMATION USED OR RELIED UPON;</td>
                                                <td>
                                                    <select id="NATURE_AND_SOURCES" name="valuation_procedure" class="form-control">
                                                        <option value="NO">NO</option>
                                                        <option value="YES">YES</option>
                                                        <option value="OTHERS">OTHERS</option>
                                                    </select>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <select id="valuation_procedure" name="valuation_procedure" class="form-control">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="report_restrictions" name="report_restrictions" class="form-control">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="factors_considered" name="factors_considered" class="form-control">
                                                        <option value="NO">NO</option>
                                                        <option value="YES">YES</option>
                                                        <option value="OTHERS">OTHERS</option>
                                                    </select>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="factors_not_considered" name="factors_not_considered" class="form-control">
                                                        <option value="NO">NO</option>
                                                        <option value="YES">YES</option>
                                                        <option value="OTHERS">OTHERS</option>
                                                    </select>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="caveats_limitations" name="caveats_limitations" class="form-control">
...
<button id="toggleBtn">Toggle Width</button>
...
$(document).ready(function(){
    ...
    updateOutput("#list_of_doc", "#list_of_doc_out");
...
function updatePurpose() {
    ...
    let tnpit2 = document.getElementById("PURPOSE2");
    ...
    tnpit2.value = tnpit2.value.replace(/\b(NPA|PERSONAL|REVALUATION|RESALE|TOP-UP|SECURITY|BANK FINANCE)\b/, selectedValue);
}
</script>
<script>
...
<script>
document.getElementById("PURCHASER_BORROWER").addEventListener("input", function() {
    document.getElementById("sale_agreement_name").value = this.value;
});
</script>
<script>
    document.querySelectorAll('.extent-checkbox').forEach(checkbox => {
        checkbox.addEventListener('change', function() {
            let selectedValues = [];
            document.querySelectorAll('.extent-checkbox:checked').forEach(cb => {
                if (cb.dataset.value !== "") {
                    selectedValues.push(cb.dataset.value);
                }
            });

            // Update the input field with selected values (comma-separated)
            document.getElementById('EXTENT_SITE').value = selectedValues.join(', ');
        });
    });
</script>
<script>
    document.querySelectorAll('.extent-checkbox2').forEach(checkbox => {
        checkbox.addEventListener('change', function() {
            let selectedValues = [];
            document.querySelectorAll('.extent-checkbox2:checked').forEach(cb => {
                if (cb.dataset.value !== "") {
                    selectedValues.push(cb.dataset.value);
                }
            });

            let combinedValue = selectedValues.join(', ');

            // Update EXTENT_SITE_2 with full value
            document.getElementById('EXTENT_SITE_2').value = combinedValue;

            // Extract numeric value (e.g., from "Extent: 480 SQ.FT" -> "480")
            let match = combinedValue.match(/\d+(\.\d+)?/);
            if (match) {
                document.getElementById('qty_1').value = match[0];
            } else {
                document.getElementById('qty_1').value = ''; // Clear if no match
            }
        });
    });
</script>
...
<script>
    document.getElementById('nature').addEventListener('change', function() {
        ...
        // If "OTHERS" is selected, leave it empty
        document.getElementById('usage_purpose').value = 
            selectedValue === 'OTHERS' ? '' : selectedValue;
    });
</script>

<script>
    document.getElementById('occupied_by').addEventListener('change', function() {
        let selectedValue = this.value;
        
        // If "OTHERS" is selected, leave it empty
        document.getElementById('occupancy_status').value = 
            selectedValue === 'OTHERS' ? '' : selectedValue;
    });
</script>

<script>
    function syncInputValues(sourceId, targetIds) {
        let sourceElement = document.getElementById(sourceId);

        if (!sourceElement) {
            console.error(`Element with ID '${sourceId}' not found.`);
            return;
        }
    ...
    // Call function once with multiple targets
    syncInputValues("building_services", ["replacement_cost", "depreciated_building_rate","depreciated_building_rate_total"]);
    syncInputValues("land_others", ["rate_land_other"]);
</script>
<script>
document.addEventListener("DOMContentLoaded", function () {
...
<script>
  ...
  const card0 = document.getElementById('fixedCard');

  function updateCardPosition() {
    const navTop = navbar.getBoundingClientRect().top;
    const navHeight = navbar.offsetHeight;

    // If the navbar is fully visible (at top of screen)
    if (navTop >= 0) {
      card0.style.top = navHeight + 25 + 'px';
    } else {
      // Navbar is hidden, move card to top
      card0.style.top = '5px';
    }
  }
...
<script>
  ...
  toggleBtn.addEventListener("click", () => {
    const currentWidth = parseInt(window.getComputedStyle(card).width);
    const newWidth = currentWidth < 1000 ? 1000 : 450;
    card.style.width = newWidth + "px";
  });
</script>

<script>
  document.getElementById('undivided_area_unit').addEventListener('change', function () {
    const input = document.getElementById('undivided_area');
    const selected = this.value;

    if (selected) {
      const baseValue = input.value.replace(/\s*(SQ\.FT|SQ\.MT|ACRE|HECTARE)?\s*$/, '').trim();
      input.value = baseValue + selected;
    }
  });
</script>
<script>
  ...
  function calculateTotalComposite() {
    const rate1Input = document.getElementById('depreciated_building_rate_total').value.trim();
    const rate2Input = document.getElementById('rate_land_other').value.trim();

    const rate1 = convertToNumber(rate1Input);
    const rate2 = convertToNumber(rate2Input);

    const total = rate1 + rate2;
    document.getElementById('total_composite').value = total.toFixed(2);
    document.getElementById('rate_1').value = total.toFixed(2);
    
  }

  document.getElementById('depreciated_building_rate_total').addEventListener('input', calculateTotalComposite);
  document.getElementById('rate_land_other').addEventListener('input', calculateTotalComposite);
</script>

<script>
function toggleSection(sectionNumber) {
    if (sectionNumber === 1) {
        const checked = document.getElementById("Show1").checked;
        if (checked) {
            document.getElementById("shoe_type1").value = document.getElementById("type1").value;
            document.getElementById("shoe_OWNER").value = document.getElementById("OWNER").value;
        } else {
            document.getElementById("shoe_type1").value = "";
            document.getElementById("shoe_OWNER").value = "";
        }
    }

    if (sectionNumber === 2) {
        const checked = document.getElementById("Show2").checked;
        if (checked) {
            document.getElementById("show_type2").value = document.getElementById("type2").value;
            document.getElementById("shoe_PURCHASER_BORROWER").value = document.getElementById("PURCHASER_BORROWER").value;
        } else {
            document.getElementById("show_type2").value = "";
            document.getElementById("shoe_PURCHASER_BORROWER").value = "";
        }
    }
}
</script>
...
function calculateBuildingAge() {
    const yearInput = document.getElementById('Year_of_Construction').value;
    const ageField = document.getElementById('building_age');
    const currentYear = new Date().getFullYear();

    const constructionYear = parseInt(yearInput);

    if (!isNaN(constructionYear) && constructionYear <= currentYear) {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function calculateRow(index) {
        ...
        const valueField = document.getElementById(`value_${index}`);
        const result = qty * rate;
        valueField.value = result.toFixed(2);
    }
    ...
    function calculateTotal() {
        ...
        document.getElementById('rounded_value').value = Math.round(total);
    }

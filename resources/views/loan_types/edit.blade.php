    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h4 font-weight-bold text-dark mb-1">
                <i class="fas fa-edit text-info mr-2"></i>Edit Loan Type
            </h2>
            <p class="text-muted small mb-0">Update loan type name.</p>
        </div>
            ...
            <form action="{{ route('loan-types.update', $loanType->id) }}" method="POST">
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" id="name" name="name" 
                           ...
                           required autofocus>
                    <small class="form-text text-muted">Updating this will update the name displayed in the dropdown.</small>
                </div>

                <div class="d-flex align-items-center pt-2">
                    <button type="submit" class="btn btn-primary px-4 py-2 font-weight-bold mr-2 shadow-sm" style="border-radius: 8px;">
                        <i class="fas fa-save mr-1"></i> Update Loan Type
                    </button>
